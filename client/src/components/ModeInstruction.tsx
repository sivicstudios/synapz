...
const ModeInstructionScreen: React.FC<ModeInstructionScreenProps> = ({ onProceed }) => {
  return (
    <div className="flex flex-col items-center justify-between h-full w-fullpb-6">
      ...
      <div className="text-center mt-16 mb-auto mx-6">
        <p className="text-sm text-[#797979]">Get all 15 questions right and secure your spot in the Hall of Fame!</p>
      </div>
